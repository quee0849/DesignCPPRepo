...
// this is the base class for the parameters; the Parameters class will be the
// interface to this using the bridge pattern. Things like ParametersConstant will inherit from this. 
// So ParametersInner just defines the interface that all inherited classes should have. 
...
// this is the bridge pattern again - so Parameters just deals with the outside world; and stores a pointer to
// a ParametersInner object and handles memory management. 
class Parameters
{
